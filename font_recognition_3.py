...
class MyWidget(QtWidgets.QWidget):
    ...
    def mouseReleaseEvent(self, event):
        ...
        img = cv2.imdecode(np.fromfile('screenshot.png', dtype=np.uint8), 1)
        ...
        for idx, contour in enumerate(contours):
            ...
            if hierarchy[0][idx][3] == 0:
                ...
                if size_max>50:
                    letter_square = cv2.copyMakeBorder(letter_square, size_max*2, size_max*2, size_max*2, 
                                                       size_max*2,cv2.BORDER_CONSTANT,value=(255,255,255))
                    letter_square = letter_square[int(size_max*1.5):int(size_max*3.5), int(size_max*1.5):int(size_max*3.5)]
                elif 20<size_max<=50:
                    letter_square = cv2.copyMakeBorder(letter_square, 10, 10, 10, 10,cv2.BORDER_CONSTANT,value=(255,255,255))
        ...
        model = load_model('model_font_recognition.keras')
